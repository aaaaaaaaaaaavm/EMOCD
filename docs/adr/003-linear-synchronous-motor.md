...
- **Coilgun (induction or reluctance).** Rejected. It needs a conductive armature — either bolted
  ...
  >
  > **"Cannot command velocity closed-loop" overstated.** Feng varies exit velocity 230 → 321.56
  > m/s by charging voltage, 10 → 16 kV, approximately linearly, and uses armature position/velocity
  ...
  > | Acceleration | 3.9 m barrel → **1352 g** mean; >600 kN peak on 20 kg → **~3060 g** | 91 m/s² = 9.3 g mean, 10.7 g peak |
  > | Energy per shot | **6.91 MJ** | 2.80 kJ |
  >
  > A standard CubeSat qualifies to ~14 g quasi-static. Feng's design is ~100× that, and needs 2470×

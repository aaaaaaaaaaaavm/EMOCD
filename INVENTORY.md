...
| A4 | Hohmann 350→500 km; single-impulse ellipse correction | superseded |
...
| A11 | Tumble-rate plausibility → 780 °/s falsified | see E13 |
...
| A22 | C5 conjunction screening (v1 bugged → v2 staggered) | `analysis/astro.py` |
...
| B3 | Reluctance → induction coilgun |
| B4 | **Coilgun → linear synchronous motor** (mid-2025) |
...
| B20 | Rated sheet current 130 → 140 kA/m |
| B21 | Paper reframed host-specific → host-agnostic |
| B22 | Value proposition → propulsion-less niche + drift seeding |
